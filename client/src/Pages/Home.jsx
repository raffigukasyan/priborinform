          ...
          <div className="advatagesWrapper">
            <div>
              ...
              <p>
                ...
                FARMPRO, ATAGO, Perten, VELP, SNOL, Mettler Toledo, Testo, Ohaus, Acom, Vibra, Cas,
                A&D Company, DEMCOM, Kett, DICKEY-john
              </p>
            </div>
            <div>
              ...
              <p>
                Оборудование поставляется со всей необходимой документацией и гарантией, отличается
                высокой точностью показаний, удобством настройки и простотой эксплуатации. Перед
                продажей проходит тщательную проверку: вы получаете только те приборы, в которых мы
                уверены и которые не подведут в ответственный момент.
              </p>
            </div>
            <div>
              ...
              <p>
                Мы оказываем информационную поддержку на всех этапах работы с заказом, несем полную
                ответственность за актуальность и качество информации
              </p>
            </div>
          </div>
        </div>
